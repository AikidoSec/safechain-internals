...
use endpoint_protection_proxy_lib::http::service::connectivity::CONNECTIVITY_DOMAIN;
...
async fn test_connectivity_http() {
    ...
    assert!(payload.contains(endpoint_protection_proxy_lib::utils::env::project_name()));
}
