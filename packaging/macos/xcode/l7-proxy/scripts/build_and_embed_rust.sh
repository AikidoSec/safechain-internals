...
RUST_BIN_SRC="$PROJECT_ROOT/target/release/safechain-l7-proxy"
RUST_BIN_DST="$TARGET_BUILD_DIR/$EXECUTABLE_FOLDER_PATH/safechain-l7-proxy-bin"

pushd "$PROJECT_ROOT" >/dev/null
cargo build --release -p safechain-l7-proxy
popd >/dev/null
